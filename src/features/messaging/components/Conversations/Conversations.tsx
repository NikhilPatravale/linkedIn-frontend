...
function Conversations() {
  ...
  const userToDisplay = conversation?.author.id === authContext?.user?.id
                ...
                <div className={classes.conversationTop}>
                  <button className={classes.profileInfo}>
                    ...
                    <div className={classes.profileDetails}>
                      ...
                      <span className={classes.companyDetails}>{`${userToDisplay?.position} at ${userToDisplay?.company}`}</span>
                    </div>
                  </button>
                  <button
