      ...
      <div className={classes.center}>
        ...
        <div className={classes.filterSection}>
          <div className={classes.filters}>
            <Button outline={true} className={classes.allFilter} onClick={() => setFilter("allPosts")}>All</Button>
            <Button outline={false} className={classes.feedFilter} onClick={() => setFilter("feed")}>Feed</Button>
          </div>
        </div>
